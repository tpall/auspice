...
function addEndOfNarrativeBlock(narrativeBlocks) {
  ...
  const endOfNarrativeSlide = {
    dataset: lastContentSlide.dataset,
    query: lastContentSlide.query,
    isEndOfNarrativeSlide: true
  };
  if (lastContentSlide.mainDisplayMarkdown) {
    endOfNarrativeSlide.mainDisplayMarkdown = lastContentSlide.mainDisplayMarkdown;
  }
